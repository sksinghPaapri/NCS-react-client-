...
const Productfinder = () => {
  return (
    ...
    >
      ...
      <div className=" w-[280px] h-[76px] sm:w-[664px] sm:h-[44px] lg:w-[1160px] lg:h-[44px] xl:w-[1320px] flex items-center justify-center mt-20 lg:mt-[100px]">
        <div>
      ...
      <div className="w-[280px] h-[405px] sm:w-[664px] sm:h-[244px] lg:w-[1160px] lg:h-[143px] xl:w-[1320px] flex flex-col items-center justify-center mt-[100px] sm:mt-[80px] lg:mt-[100px]">
        {/* row-2 row2.1 */}
        <div className="w-[280px] h-[21px] sm:w-[664px] sm:h-[21px] lg:w-[1160px] lg:h-[21px] xl:w-[1320px] flex items-center justify-center md:justify-start gap-1">
          <div>
            <svg
        ...
        {/* row 2 row2.2 */}
        <div className="mt-10 w-[289.4px] h-[405px] sm:w-[664px] sm:h-[183px] lg:w-[1160px] lg:h-[82px] xl:w-[1320px] flex flex-col sm:flex-row items-center justify-center md:justify-start gap1">
          {/* row 2 row2.2 col 1 */}
          <div className="w-[289.4px] h-[100px] sm:w-[664px] sm:h-[61px] lg:w-[743px] lg:h-[82px] xl:w-[903px] flex flex-col items-center justify-center gap-1">
            <p className="text-sm sm:text-base text-gray-900 font-bold w-[289.4px] h-[48px] sm:w-[664px] sm:h-[27px] lg:w-[743px] lg:h-[27px] xl:w-[903px] flex px-9 sm:px-0">
              The following stores have purchased these products:
            </p>
            <p className="text-base sm:text-[16px] text-gray-500 w-[289.4px] h-[42px] sm:w-[664px] sm:h-[27px] lg:w-[743px] lg:h-[27px] xl:w-[903px] flex">
              Contact retailers directly for inventory information
            </p>
          </div>
          {/* row 2 row2.2 col 2 buttons and dropdown */}
          <div className="w-[204px] h-[204px] sm:w-[377px] sm:h-[82px] lg:w-[377px] lg:h-[82px] flex flex-col sm:flex-row">
            <div className="w-[204px] h-[82px] flex flex-col gap-10 sm:gap-5">
              <p className="w-[134px] h-[27px] text-sm">Product Finder</p>
            ...
            <div className="w-[153px] h-[82px] flex flex-col">
              <p className="w-[153px] h-[27px] font-bold text-sm">
                Print / Download
              </p>
