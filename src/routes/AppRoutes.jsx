    ...
    return (
        <BrowserRouter basename='/website'>
            ...
            <Routes>
                ...
                <Route path="/region-customer" element={(user || customer) ? <RegionAndCustomer /> : <Body />} />
                <Route path="/forgot-password" element={<ForgotPassword />} />
                <Route path="/reset-password/:token" element={<ResetPassword />} />
                {/* <Route path="/profile" element={<UserProfile />} /> */}
                <Route path="/recent-customer-page" element={(user || customer) ? <RecentCustomers /> : <Body />} />
                <Route path="/profile" element={(user || customer) ? <CustomerProfile /> : <Body />} />
                <Route path="/customer-profile" element={(user || customer) ? <CustomerProfile /> : <Body />} />
                <Route path="/designers-list" element={<DesignerList />} />
                <Route path="/designer-profile/:id" element={<DesignerProfile />} />
                <Route path="/resource-category-list" element={<ResourceCategoryList />} />
                ...
                <Route path="/rapid-order" element={(user || customer) ? <RapidOrder /> : <Body />} />
                <Route path="/cart-detail" element={(user || customer) ? <CartDetail /> : <Body />} />
                <Route path="/search-detail/:searchItem" element={<SearchDetail />} />
                <Route path="/wishlist-detail" element={(user || customer) ? <WishList /> : <Body />} />
