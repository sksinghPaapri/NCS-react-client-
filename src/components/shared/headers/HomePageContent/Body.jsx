...
//       <div>
//         <div
//           className="p-4 pt-16 xl:ms-16 text-3xl sm:text-5xl flex justify-center lg:justify-start"
//           style={{ fontFamily: "DM Serif Display" }}
//         >
//           What's New
//         </div>
//         <div className="flex gap-10 flex-col">
//           <div className=" flex flex-col gap-10 lg:flex-row mx-5 md:mx-16 xl:mx-20">
//             <div className="lg:w-1/2 h-auto flex flex-col justify-center">
//               <img src={Mask} alt="Image" className="h-2/3" />
//               <div
//                 className="flex justify-center mx-6 lg:justify-start my-6 text-xl sm:text-2xl"
//                 style={{ fontFamily: "DM Serif Display" }}
//               >
//                 Promotion Example
//               </div>
...
//               <img src={Mask} alt="Image" className="h-2/3" />
//               <div
//                 className="flex justify-center mx-0 md:mx-6 lg:justify-start my-6 text-xl"
//                 style={{ fontFamily: "DM Serif Display" }}
//               >
...
//       </div>
//       {/* Northcott Fabrics */}
//       <div className="flex flex-col justify-center text-center w-full h-fit lg:h-72 text-white bg-black bg-[url('https://media.istockphoto.com/id/184601291/photo/xxxl-dark-concrete.webp?b=1&s=170667a&w=0&k=20&c=KRRXq0P41imqerPjYF4EgX7QOdbybyprM8ofKYoIzT4=')] bg-no-repeat bg-center bg-cover sm:h-auto">
//         <div
//           className="flex justify-center text-3xl pt-5 mt-[50px]"
//           style={{ fontFamily: "DM Serif Display" }}
//         >
//           Northcott Fabrics
//         </div>
...
//           prints with a silky hand can be found in quilt and craft shops around
//           the world. We are known for our superior quality and admirable
//           customer service. The quilting industry is where we have built a name
//           for ourselves and a community of great customers, distributors and
//           partners. We design and partner with the best designers to produce
//           fabrics to sell wholesale to your local shops and distributors.
//         </div>
//         <div className="flex justify-center mx-5">
//           <button
//             type="button"
//             className=" text-black  bg-[#E2A856] font-medium rounded-sm text-sm px-5 py-2.5 text-center me-2 mb-10 w-48"
//           >
//             LEARN MORE
//           </button>
//         </div>
...
//       <div>
//         <div
//           className="pt-10 text-center text-3xl sm:text-5xl tracking-wide"
//           style={{ fontFamily: "DM Serif Display" }}
//         >
//           Featured Categories
//         </div>
//         <div className="grid grid-cols-1 lg:grid-cols-3 grid-flow-row lg:px-20 lg:gap-16 px-5 my-10 gap-10 lg:mx-0 sm:mx-40 ">
...
//       {/* 5) */}
//       {/* featured designer */}
//       <div className="flex flex-col lg:flex-row justify-center h-auto text-white bg-[#CECECC]">
//         <div className="py-10 w-full lg:w-1/2 flex justify-center">
//           <img src={Designer} alt="Image" className="h-72 w-72 rounded-full" />
//         </div>
...
//             <button
//               type="button"
//               className="uppercase font-semibold text-black bg-[#E2A856] rounded-sm text-sm py-2.5 px-2 text-center mb-10 w-64 md:w-96"
//             >
...
//           </div>
//         </div>
//         <div className="flex flex-col mx-0 xl:mx-20 lg:mx-20 lg:flex-row lg:w-3/4 md:gap-5">
//           <div className=" lg:w-1/2 md:w-fit bg-white flex justify-center mx-5 lg:mx-0 md:mx-28">
//             <a href="#">
//               <img src={Property1} alt="Image" />
//             </a>
//           </div>
//           <div className="lg:w-1/2 flex flex-col items-center gap-10 lg:gap-6 mt-10 lg:mt-0 me-0 md:me-6 lg:me-0 lg:px-48 ">
//             <a href="#">
//               <div className="flex flex-col md:flex-row gap-5">
//                 <img className="lg:h-32" src={Mask1} alt="Image" />
//                 <div className="flex flex-col gap-5 justify-start">
//                   <h4 className="text-gray-400">Free Patterns</h4>
//                   <h2 className="font-bold w-60">
...
//             <a href="#">
//               <div className="flex flex-col md:flex-row gap-5">
//                 <img className="lg:h-32" src={Mask2} alt="Image" />
//                 <div className="flex flex-col gap-5 justify-start">
//                   <h4 className="text-gray-400">Get Inspired!</h4>
//                   <h2 className="font-bold w-60">Whiskers and Wine </h2>
//                   <img className="w-24" src={frame} alt="Image" />
//                 </div>
//               </div>
//             </a>
...
//             <a href="#">
//               <div className="flex flex-col md:flex-row gap-5">
//                 <img className="lg:h-32" src={Mask3} alt="Image" />
//                 <div className="flex flex-col gap-5 justify-start">
...
//               <div className="flex flex-col md:flex-row gap-5">
//                 <img className="lg:h-32" src={Mask4} alt="Image" />
//                 <div className="flex flex-col gap-5 justify-start">
//                   <h4 className="text-gray-400">Free Patterns</h4>
//                   <h2 className="font-bold w-60">
...
//         <div className="font-bold text-[28px] lg:min-w-96 max-w-2xl p-4 md:p-10 text-center">
//           <p className="">
...
//       {/* 8) */}
//       {/* <Carousel /> */}
//       {/* <div className="h-[130px] w-[280px] md:h-[150px] md:w-[624px] lg:w-[1160px] lg:h-[260px] mb-10 md:mb-0 mx-auto">
//         <CarouselBottom />
//       </div> */}
//       {/* 9) */}
//       {/* body footer */}
//       <div className="mt-0 md:mt-44 flex flex-row items-center justify-center gap-5 m-10">
//         <a href="#">
